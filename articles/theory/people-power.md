...
> 
> This guide is about the concept of "people power" - the strength in collective action. It is not about the [People Power Revolution](https://en.wikipedia.org/wiki/People_Power_Revolution?utm_source=activisthandbook.org) in the Philippines in 1986.
...
-   **Making decisions together:** People power can happen in your living room. It is about learning how to [make decisions together](/organising/decisions). When you turn an unproductive fight into a valuable [dialogue](/organising/facilitating), congratulations, you just built people power! Because if your community can make good decisions together, taking into account the needs of all your members, you have managed to upgrade democracy and made existing power structures irrelevant. When we act in unison, we question the necessity of intermediaries to make decisions on our behalf.
    
-   **Directly challenging existing power structures:** People power also happens on the streets. Smart [campaign strategies](/strategy) can help you build power that challenges the status quo. Effective [campaign](/organising/campaign) plans allow you to draw a pathway from being a collection of weak individuals to a strong collective that cannot be ignored.
...
This guide discusses people power from a more theoretical view. For practical step-to-step guides on how to build people power, check out the rest of [Activist Handbook](/introduction)!

## Q&A

### **What is the role of technology in people power?**

[Technology](/tools) can play a significant role in mobilizing and organizing people power. For example, [social media](/tools/social-media) platforms can be used to mobilise people for a protest, [petitions](/tactics/petition) can be used to collect contact details of potential supporters, and [crowdfunding](/organising/fundraising/crowdfunding) tools can help movements stay financially independent.
...
Different [decision making models](/organising/decisions) fit different kinds of groups: there is no one-fits-all solution. However, leadership plays an important role within all impactful forms of activism (learn more about [leaderful organizing](https://commonslibrary.org/leadership-and-leaderful-organizing-research-on-building-leaderful-movements-in-europe/?utm_source=activisthandbook.org), and what it means to be a leader).
...
Many movements struggle with issues around [leadership](https://commonslibrary.org/leadership-and-leaderful-organizing-research-on-building-leaderful-movements-in-europe/?utm_source=activisthandbook.org). Sometimes, there can be clashes over who should be making key decisions or shaping the campaign’s direction.

### **Astroturfing or** co-optation

[Astroturfing](https://en.wikipedia.org/wiki/Astroturfing?utm_source=activisthandbook.org) refers to the practice of creating an image of widespread grassroots support for a cause, where little such support exists. It's often employed by corporations or interest groups to push their own narratives. This can create confusion and mistrust among the real activists.
...
[Fundraising](/organising/fundraising) is critical for driving a movement. Relying heavily on few or just one source of funding can limit the scope of action if the source decides to withdraw their financial support.
...
You can make this guide about people power better! Here are some suggestions:

-   Find more external resources that discuss the concept of people power
    
-   Suggest sub-topics to elaborate on
...
-   [What does it take to build people power](https://changemakerspodcast.org/what-does-it-take-to-build-people-power/?utm_source=activisthandbook.org) by Amanda Tattersall
...
-   [Measuring People Power in 2020+](https://mobilisationlab.org/resources/measuring-people-power/?utm_source=activisthandbook.org) by Mobilisation Lab
    

### Copyright

-   [Book: It's All About Power](https://commonslibrary.org/its-all-about-power-a-guide-to-thinking-differently-about-power-for-solidarity-in-social-change/?utm_source=activisthandbook.org) by Sheila McKechnie Foundation
    
-   [Academic: People Power Since 1980, Examining Reasons for its Spread, Success and Failure](https://www.jstor.org/stable/24233235?utm_source=activisthandbook.org) by April Carter (2013)