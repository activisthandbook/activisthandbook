...
title: >
  Nonprofit CRM
description: >
  How to select a CRM for your nonprofit or activist organisation?
langCode: en
...
> **Our honest approach:** Activist Handbook is written by volunteers. We do not get paid anything for talking about any of the CRMs we discuss. No affiliate links, no sponsored content. Our website stays online thanks to people who [**donate**](https://activisthandbook.org/donate).
> 
> **Article quality:** ⭐️⭐️⭐️ (3/5)

## Summary

-   **What is it?** A CRM (Customer/Constituent Relationship Management) tool is useful for activists to track and manage interactions with supporters. It is better than a spreadsheet.
...
-   **📝 Content Management System (CMS)**: This is the system you use to manage the content on your website. Whether it's blog posts, news updates, videos, or event notices, your CMS is what allows you to keep your site's content fresh and relevant.
    
-   **📱 Forms**: Forms are part of the tools to gather data about your supporters. Be it sign up forms, donation forms, or petition forms, whatever data captured is stored in your CRM for future reference. This data helps you understand the preferences, contributions, and engagement of your supporters.
    
-   **✉️ Email Marketing**: One of the keys to successful activism is regular and meaningful communication with your supporters. The data collected helps you segment your audience and send personalized messages, ensuring you reach people with the right messages at the right time. Sometimes, a CRM includes email marketing functionality. Other times, you need a different tool for it, such as MailChimp.
...
-   **☎️ Manage Contacts:** As an activist, you augment your work by building a network of supporters, volunteers or donors. CRM allows managing all contact details and interactions of these people in one place.
    
-   **❤️ Increase engagement:** It can help you track correspondence and engagement with each contact, ensuring that each relationship is nurtured properly. Not everyone you engage with will need the same type and level of interaction. CRM allows you to segment your contacts into different groups, aiding targeted communication.
    
-   **😅 Efficiency:** It enhances efficiency by automating repetitive tasks such as emails, newsletters, reminders, and reports so you can focus on your primary tasks, like planning campaigns or meeting with lawmakers.
    
-   **🙌 Collaboration:** Activism often involves working with a team. Having a CRM ensures that everyone on your team can see what’s been done and what needs to be done, which improves coordination and accountability.
    
-   **🤑 Fundraising:** If your activism includes fundraising, a CRM can help manage donations and track donor behavior, providing insights to assist in future fundraising campaigns.
    
-   **📊 Reporting:** Many CRM provide strong reporting features. This can help you analyze trends, see your progress, and make data-driven decisions.
    
-   **📆 Event Management:** Some CRM systems feature event management tools, allowing you to manage event invitations, RSVPs, and follow-ups all from one system.
...
-   **✅ Active (upgrade potential)** → after X period put in **upgrade**
    
-   **✅ Active (satisfied in current role)** → after X period, put in **retain**
    
-   ❌ **No response (did not pick up phone/not convenient)** → put back in last column to retry after X period, unless a retry has already happened (ideally, you're able to set a time yourself when to call back, so you can take their preference into account)
    
-   ❌ **Not interested**
    
-   ❌ **Interested, but not right now** → put in first contact after X period
    
-   ❌ **Contact lost (reason unknown)**
    
-   ❌ **Left because of conflict**
...
-   [**ControlShift Labs**](https://www.controlshiftlabs.com/?utm_source=activisthandbook.org): great tool for organising distributed events
    
-   [**SupporterBase**](https://www.supporterbase.com/?utm_source=activisthandbook.org)
    
-   [**Zetkin**](https://www.zetk.in/?utm_source=activisthandbook.org)
    
-   [**Nation Builder**](https://nationbuilder.com/?utm_source=activisthandbook.org): controversial for supporting conservatives
    
-   [**CallHub**](https://qomon.com/?utm_source=activisthandbook.org)
    
-   [**GlassFrog**](https://www.glassfrog.com/?utm_source=activisthandbook.org)
...
> ⭐️ **Want complete customisability?** We have created a complete guide on how you can [**use Directus as your CRM**](/tools/stack/directus).
...
-   [**Campaign Deputy**](https://index.staclabs.io/tools/CampaignDeputy?utm_source=activisthandbook.org): Campaign Deputy is a fundraising CRM to help you track your donors, communicate, and file your compliance reports.
    
-   [**GoodChange**](https://goodchange.app/?utm_source=activisthandbook.org): GoodChange is the intersection of responsive financial technology and advocacy fundraising. Combining the latest fintech and financial management innovations with relationship-driven fundraising strategies, GoodChange provides the power to reach, convert, and engage new and existing donors.
...
-   [Quiller](https://index.staclabs.io/tools/Quiller?utm_source=activisthandbook.org)
    

#### United States elections

-   [SwipeBlue](https://index.staclabs.io/tools/SwipeBlue?utm_source=activisthandbook.org) (US, democrats)
    
-   [OpenField](https://index.staclabs.io/tools/OpenField?utm_source=activisthandbook.org) (US, progressives only)
    
-   [CiviTech](https://index.staclabs.io/tools/Civitech?utm_source=activisthandbook.org)
    
-   [BallotReady](https://index.staclabs.io/tools/BallotReady?utm_source=activisthandbook.org)
    
-   [GetThru](https://index.staclabs.io/tools/GetThru?utm_source=activisthandbook.org)