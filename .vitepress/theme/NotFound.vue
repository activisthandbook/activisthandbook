<template>
  <div class="vp-doc" v-if="!router.route.path.startsWith('/en/')">
    ...
    <p style="margin-top: 64px">
      <i>
        Activist Handbook is written by volunteers, and sometimes something goes
        wrong. You can help us fix this broken page! Everyone can edit our
        website. Create a new page for this path or edit the broken link.
      </i>
    </p>
    <strong>
